...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "DIU Cover" },
      { property: "og:title", content: "DIU Cover" },
      ...
      { name: "twitter:title", content: "DIU Cover" },
      ...
      { name: "apple-mobile-web-app-title", content: "DIU Cover" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=DM+Sans:wght@300;400;500;600;700&display=swap" },
